...
/**
 * An interface for building {@link RpcCallDetails}s specialized for a specific gRPC call with
...
public interface LoggingHandler<ReqT, RespT> {
  ...
  /**
   * Returns a {@link RpcCallDetails} based on the requests and responses handled by this
   * handler.
   */
